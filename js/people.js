...
const memberDetails = {
  yuyu: `
    ...
    <p>Research interests include acoustic manipulation, acoustic tweezers, and magnetidue robotics. She enjoys painting and exploring novel biomedical applications of acoustic fields.</p>
  `,
  chengxi: `
    ...
    <p>Focused on real-time acoustic holography and AI-enhanced field reconstruction techniques. She enjoys coding and is passionate about everything in daily life. She's the person that consistently keep a healthy sleeping time</p>
  `,
  jiaqi: `
    ...
    <p>Interested in hardware construction and manipulation, in charge of the acoustic tweezers project. She likes playing chess and is keen on riding bicycles.</p>
  `,
  yuting: `
  ...
  mingyue: `
    ...
    <p>Researches MEMS-based sensors and acoustic devices, very good at signal processing. He likes playing basketball.</p>
  `,
  zhenhuan: `
    ...
    <p>Hard and strong theoretical fundamentals, with a focus on acoustic manipulation and control systems. He likes playing video games.</p>
  `,
  fuxiang: `
    ...
    <p>Works on real-time control algorithms and embedded systems, and is in charge of nano-scale 3D surface reconstruction and nanorobot manipulation. He enjoys playing video games.</p>
  `,
  liuqing: `
  ...
  jieyun: `
    ...
    <p>Works on AI-driven acoustic imaging technologies. She enjoys playing the piano and is focused on integrating neural networks with inverse acoustic problem-solving for high-resolution imaging.</p>
  `,
  muxin: `
  ...
  `,
    ...
    <p>Dr. Su has published dozens of papers in top-tier journals such as TASE, SMCA, Measurement, and PR, and conference proceedings including ICRA and IROS. He also serves as a reviewer for multiple international journals.</p>
  `,
    huaming: `
